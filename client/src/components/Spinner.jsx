...
const Spinner = () => {
    return (
        <div className='flex justify-center'>
            <div className="absolute top-1/2 left-1/2 -mt-4 -ml-2 h-8 w-4 text-gray-700">
                <div className="absolute z-10 -ml-2 h-8 w-8 animate-bounce">
                    <svg xmlns="http://www.w3.org/2000/svg" className="animate-spin w-10" fill="currentColor" stroke="currentColor" strokeWidth="0" viewBox="0 0 16 16">
